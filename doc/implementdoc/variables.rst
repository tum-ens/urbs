...
.. table:: *Table: Model Variables*
    ...
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | Variable                               | Unit | Description                       | Program Variable Name      |
    +========================================+======+===================================+============================+
    | **Cost Variables**                     |      |                                   |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\zeta`                          | €    | Total System Cost                 | ``m.costs``                |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    ...
    | **Commodity Variables**                |      |                                   |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\rho_{yvct}`                    | MWh  | Stock Commodity Source Term       | ``m.e_co_stock``           |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\varrho_{yvct}`                 | MWh  | Sell Commodity Source Term        | ``m.e_co_sell``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\psi_{yvct}`                    | MWh  | Buy Commodity Source Term         | ``m.e_co_buy``             |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | **Process Variables**                  |      |                                   |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\kappa_{yvp}`                   | MW   | Total Process Capacity            | ``m.cap_pro``              |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\hat{\kappa}_{yvp}`             | MW   | New Process Capacity              | ``m.cap_pro_new``          |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\beta_{yvp}`                    | -    | New Process Capacity Units        |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\tau_{yvpt}`                    | MWh  | Process Throughput                | ``m.tau_pro``              |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\epsilon_{yvcpt}^\text{in}`     | MWh  | Process Input Commodity Flow      | ``m.e_pro_in``             |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\epsilon_{yvcpt}^\text{out}`    | MWh  | Process Output Commodity Flow     | ``m.e_pro_out``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    ...
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\kappa_{yaf}`                   | MW   | Total Transmission Capacity       | ``m.cap_tra``              |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\hat{\kappa}_{yaf}`             | MW   | New Transmission Capacity         | ``m.cap_tra_new``          |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\beta_{yaf}`                    | -    | New Transmission Capacity Units   |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\pi_{yaft}^\text{in}`           | MWh  | Transmission Input Commodity Flow | ``m.e_tra_in``             |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\pi_{yaft}^\text{out}`          | MWh  | Transmission Output Commodity Flow| ``m.e_tra_out``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | **Storage Variables**                  |      |                                   |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\kappa_{yvs}^\text{c}`          | MWh  | Total Storage Size                | ``m.cap_sto_c``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\hat{\kappa}_{yvs}^\text{c}`    | MWh  | New Storage Size                  | ``m.cap_sto_c_new``        |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\beta_{yvs}^\text{c}`           | -    | New Storage Size Units            |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\kappa_{yvs}^\text{p}`          | MW   | Total Storage Power               | ``m.cap_sto_p``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\hat{\kappa}_{yvs}^\text{p}`    | MW   | New Storage Power                 | ``m.cap_sto_p_new``        |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\beta_{yvs}^\text{p}`           | -    | New Storage Power Units           |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\epsilon_{yvst}^\text{in}`      | MWh  | Storage Input Commodity Flow      | ``m.e_sto_in``             |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\epsilon_{yvst}^\text{out}`     | MWh  | Storage Output Commodity Flow     | ``m.e_sto_out``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\epsilon_{yvst}^\text{con}`     | MWh  | Storage Energy Content            | ``m.e_sto_con``            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | **Demand Side Management Variables**   |      |                                   |                            |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\delta_{yvct}^\text{up}`        | MWh  | DSM Upshift                       | ``m.dsm_up``               |
    +----------------------------------------+------+-----------------------------------+----------------------------+
    | :math:`\delta_{t,tt,yvc}^\text{down}`  | MWh  | DSM Downshift                     | ``m.dsm_down``             |
    +----------------------------------------+------+-----------------------------------+----------------------------+
