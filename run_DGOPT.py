...
input_files = 'kerber_dorfnetz_urbs_lindistflow_2022_HA_Technikkatalog_mobdemshift_heatdemfix_new_cable_param_hp_mob_overhaul_v7.xlsx'  # for single year file name, for intertemporal folder name
input_dir = 'Input'
