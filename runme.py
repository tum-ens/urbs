...
def run_scenario(input_file, timesteps, scenario, result_dir,
                 plot_tuples=None,  plot_tuples_names=None, plot_periods=None,
                 report_tuples=None, report_tuples_names=None):
    ...
    Args:
        ...
        report_tuples_names: (optional) dict of names for report_tuples
    ...
    urbs.report(
        ...
        report_tuples_names=report_tuples_names)
    ...
    urbs.result_figures(
        ...
        plot_tuples_names=plot_tuples_names,
