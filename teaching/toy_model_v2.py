...
# Data
# ====
timesteps = list(range(25)) # numbers from 0 to 24
dt = 1 # time interval between two consecutive steps, in this case 1 hour
support_timeframes = [2020, 2030, 2040, 2050]
sites = ["DE", "FR"]
commodities = ["Elec", "Heat", "CO2", "Oil", "Solar"]
com_type = ["Demand", "Stock", "Env", "SupIm"]
process = ["Oil plant", "PV plant", "Heat pump"]
cost_type = ['Invest', 'Fixed', 'Variable', 'Fuel', 'Environmental']
